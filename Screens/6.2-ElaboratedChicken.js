...
import {
  ...
  MediumServing,
  SmallServings,
} from '../DATA/6.2-ElaboratedChickendb.js';
    ...
    <View style={{flex: 1}}>
      <ImageBackground
        ...
        <View
          ...
          <Image
            source={ElaboratedMeatsdb[1].imagePath}
            resizeMode="contain"
          ...
          <View>
            <View style={{...styles.elaboratedDataText, marginBottom: 3}}>
              <Text style={{...styles.elaboratedDataName, marginTop: 2}}>
                {/* Bread */}
                {ElaboratedMeatsdb[1].category}
              </Text>
              <Text style={styles.elaboratedDataInfo}>
                {ElaboratedMeatsdb[1].Calorie}
              </Text>
            </View>
